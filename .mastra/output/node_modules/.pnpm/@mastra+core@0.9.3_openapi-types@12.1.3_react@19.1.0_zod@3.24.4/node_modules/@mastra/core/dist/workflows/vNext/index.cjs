...
var ExecutionEngine = class extends chunkRO52JMKQ_cjs.MastraBase {
  mastra;
  constructor({ mastra }) {
...
function createStep(params) {
  ...
  if (params instanceof chunkFXAV2WYX_cjs.Tool) {
...
var NewWorkflow = class extends chunkRO52JMKQ_cjs.MastraBase {
  id;
  description;
  inputSchema;
  outputSchema;
