...
var AgentNetwork = class extends chunkRO52JMKQ_cjs.MastraBase {
  #instructions;
  #agents;
  #model;
  #routingAgent;
  #agentHistory = {};
  constructor(config) {
    super({ component: chunkO7IW545H_cjs.RegisteredLogger.NETWORK, name: "AgentNetwork" });
  ...
  getTools() {
    return {
      transmit: chunkFXAV2WYX_cjs.createTool({
        id: "transmit",
